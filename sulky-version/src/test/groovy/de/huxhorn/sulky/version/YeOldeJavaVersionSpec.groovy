...
public class YeOldeJavaVersionSpec extends Specification {

    @Unroll
    def 'parse("#versionString") returns #expectedVersion'(String versionString, YeOldeJavaVersion expectedVersion) {
        when:
    ...
    def 'toShortVersionString() works'() {
        when:
