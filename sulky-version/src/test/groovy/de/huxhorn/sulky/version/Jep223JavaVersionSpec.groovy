...
*/
    ...
    def isPatternMatching(String description, String versionString, Jep223JavaVersion expectedVersion) {
        when:
        ...
        'withOpt'          | '9.7.6.5-ea-opt'            | new Jep223JavaVersion([9, 7, 6, 5] as int[], 'ea', 0, 'opt')
    ...
    def longString(String description, String expectedVersionString, Jep223JavaVersion version) {
        when:
    ...
    def getters(String description, String versionString, List<Integer> expectedVersionNumbers, int expectedMajor, int expectedMinor, int expectedSecurity, String expectedPre, int expectedBuild, String expectedOpt) {
        when:
        ...
        where:
        description        | versionString                                 | expectedVersionNumbers   | expectedMajor | expectedMinor | expectedSecurity | expectedPre | expectedBuild | expectedOpt
        'Early Access'     | '9.0.0-ea+19'                                 | [9, 0, 0]                | 9             | 0             | 0                | 'ea'        | 19            | null
        'Major'            | '9.0.0+100'                                   | [9, 0, 0]                | 9             | 0             | 0                | null        | 100           | null
        'Security #1'      | '9.0.1+20'                                    | [9, 0, 1]                | 9             | 0             | 1                | null        | 20            | null
        'Security #2'      | '9.0.2+12'                                    | [9, 0, 2]                | 9             | 0             | 2                | null        | 12            | null
        'Minor #1'         | '9.1.2+62'                                    | [9, 1, 2]                | 9             | 1             | 2                | null        | 62            | null
        'Security #3'      | '9.1.3+15'                                    | [9, 1, 3]                | 9             | 1             | 3                | null        | 15            | null
        'Security #4'      | '9.1.4+8'                                     | [9, 1, 4]                | 9             | 1             | 4                | null        | 8             | null
        'Minor #2'         | '9.2.4+45'                                    | [9, 2, 4]                | 9             | 2             | 4                | null        | 45            | null

        'Early Access'     | '9-ea'                                        | [9]                      | 9             | 0             | 0                | 'ea'        | 0             | null
        'Major'            | '9'                                           | [9]                      | 9             | 0             | 0                | null        | 0             | null
        'Security #1'      | '9.0.1'                                       | [9, 0, 1]                | 9             | 0             | 1                | null        | 0             | null
        'Security #2'      | '9.0.2'                                       | [9, 0, 2]                | 9             | 0             | 2                | null        | 0             | null
        'Minor #1'         | '9.1.2'                                       | [9, 1, 2]                | 9             | 1             | 2                | null        | 0             | null
        'Security #3'      | '9.1.3'                                       | [9, 1, 3]                | 9             | 1             | 3                | null        | 0             | null
        'Security #4'      | '9.1.4'                                       | [9, 1, 4]                | 9             | 1             | 4                | null        | 0             | null
        'Minor #2'         | '9.2.4'                                       | [9, 2, 4]                | 9             | 2             | 4                | null        | 0             | null

        'Security 2013/04' | '7.4.10+11'                                   | [7, 4, 10]               | 7             | 4             | 10               | null        | 11            | null
        'Security 2013/06' | '7.4.11+15'                                   | [7, 4, 11]               | 7             | 4             | 11               | null        | 15            | null
        'Minor    2013/09' | '7.5.11+43'                                   | [7, 5, 11]               | 7             | 5             | 11               | null        | 43            | null
        'Security 2013/10' | '7.5.12+18'                                   | [7, 5, 12]               | 7             | 5             | 12               | null        | 18            | null
        'Security 2014/01' | '7.5.13+13'                                   | [7, 5, 13]               | 7             | 5             | 13               | null        | 13            | null
        'Security 2014/04' | '7.6.14+13'                                   | [7, 6, 14]               | 7             | 6             | 14               | null        | 13            | null
        'Minor    2014/05' | '7.6.14+19'                                   | [7, 6, 14]               | 7             | 6             | 14               | null        | 19            | null
        'Security 2014/07' | '7.6.15+20'                                   | [7, 6, 15]               | 7             | 6             | 15               | null        | 20            | null

        'Security 2013/04' | '7.4.10'                                      | [7, 4, 10]               | 7             | 4             | 10               | null        | 0             | null
        'Security 2013/06' | '7.4.11'                                      | [7, 4, 11]               | 7             | 4             | 11               | null        | 0             | null
        'Minor    2013/09' | '7.5.11'                                      | [7, 5, 11]               | 7             | 5             | 11               | null        | 0             | null
        'Security 2013/10' | '7.5.12'                                      | [7, 5, 12]               | 7             | 5             | 12               | null        | 0             | null
        'Security 2014/01' | '7.5.13'                                      | [7, 5, 13]               | 7             | 5             | 13               | null        | 0             | null
        'Security 2014/04' | '7.5.14'                                      | [7, 5, 14]               | 7             | 5             | 14               | null        | 0             | null
        'Minor    2014/05' | '7.6.14'                                      | [7, 6, 14]               | 7             | 6             | 14               | null        | 0             | null
        'Security 2014/07' | '7.6.15'                                      | [7, 6, 15]               | 7             | 6             | 15               | null        | 0             | null

        'Whatever'         | '9.7.6.5.4.3'                                 | [9, 7, 6, 5, 4, 3]       | 9             | 7             | 6                | null        | 0             | null
        'withOpt'          | '9.7.6.5-ea-opt'                              | [9, 7, 6, 5]             | 9             | 7             | 6                | 'ea'        | 0             | 'opt'
        'full'             | '9.7.6.5.4.3.2.1-ea+49-opt'                   | [9, 7, 6, 5, 4, 3, 2, 1] | 9             | 7             | 6                | 'ea'        | 49            | 'opt'
        'zeroSecurity'     | '9.1.0'                                       | [9, 1, 0]                | 9             | 1             | 0                | null        | 0             | null
        'verona'           | '9-internal+17-2015-07-14-120103.iris.verona' | [9]                      | 9             | 0             | 0                | 'internal'  | 17            | '2015-07-14-120103.iris.verona'
    }

    @Unroll('Jep223JavaVersion.toShortVersionString() is #expectedVersionString. (#description)')
    def shortString(String description, String expectedVersionString, Jep223JavaVersion version) {
        when:
        ...
        'Whatever'         | '9.7.6'               | new Jep223JavaVersion([9, 7, 6, 5, 4, 3] as int[], null, 0, null)
        'withOpt'          | '9.7.6-ea'            | new Jep223JavaVersion([9, 7, 6, 5] as int[], 'ea', 0, 'opt')
        'full'             | '9.7.6-ea'            | new Jep223JavaVersion([9, 7, 6, 5, 4, 3, 2, 1] as int[], 'ea', 49, 'opt')
...
//    }
    ...
    def 'comparing instances works using compareTo and equals'() {
        when:
