...
public class HighestVersionMapper
	implements ClassStatisticMapper
{
	private char highestVersionChar =0;

	public char getHighestVersionChar()
	{
		return highestVersionChar;
	}

	public ClassFileVersion getHighestVersion()
	{
		return ClassFileVersion.getByMajorVersionChar(highestVersionChar);
	}
	...
	public void evaluate(String source, String packageName, String className, char majorVersion)
	{
		...
		if(majorVersion > highestVersionChar)
		{
			highestVersionChar = majorVersion;
		}
	}
