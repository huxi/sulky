...
@SuppressWarnings({"PMD.ShortClassName", "PMD.SystemPrintln", "PMD.AvoidPrintStackTrace", "PMD.DoNotTerminateVM"})
public final class Main
{
	...
	private static boolean showVersionWarning(JavaVersion requiredJavaVersion)
	{
		final String msg="This application requires Java "
				...
				+ "!\n\n"
				+ "Find the latest Java versions at https://adoptium.net/";
			...
			implements VersionRunnable
	{
		...
		private static final Object[] OPTIONS = {YES_OPTION, NO_OPTION};
