...
{
	private Map<String, Set<Character>> sourceVersions =new HashMap<String, Set<Character>>();
	...
	public void evaluate(String source, String packageName, String className, char majorVersion)
	{
		...
		Set<Character> versions = sourceVersions.get(source);
		if(versions == null)
		{
			versions = new TreeSet<Character>();
			sourceVersions.put(source, versions);
		}
